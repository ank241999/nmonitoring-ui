...
// import { MatDialog, MAT_DATE_FORMATS, DateAdapter, MAT_DATE_LOCALE } from '@angular/material';
...
export class PersonscannedreportgraphComponent implements OnInit {
  ...
  reportpersonspecificthreatPercentagebarChartPlugins = [];
  ...
  public pieChartData = [];       // Remove SingleDataSet

  // throughputColor = [{
  //   backgroundColor: '#FE6265'
  // },
  // {
  //   backgroundColor: '#99BBF1'
  // }];
  ...
  reportpersonspecificthreatpercent(): ChartOptions {
    return {
      ...
      //           return (tooltipItem['datasetIndex'] === 0 ? 'Alarms ' : 'No Alarm ')
      //             + tooltipItem['value'] + '%';
      //         }
      //       }
      //     },
  ...
  ngOnInit() {
    ...
    this.reportpersonspecificthreatPercentagebarChartPlugins = [{
  ...
  throughPut(filterValue) {
    ...
    this.reportService.getThroughputFilter(this.fromDate, this.toDate, filterValue).subscribe(res => {
      ...
      this.reportpersonspecificthreat.push({ 'data': totalscanned, 'label': 'Total Persons with alarms' });
      this.reportpersonspecificthreat.push({ 'data': totalNoobject, 'label': ' Total Persons with no alarms' });

      this.reportpersonspecificthreatPercentage.push({ 'data': totalscannedPercentage, 'label': 'Total Persons with alarms' });
      this.reportpersonspecificthreatPercentage.push({ 'data': totalNoobjectPercentage, 'label': ' Total Persons with no alarms' });
  ...
  onDone() {
    ...
    this.reportService.getThroughputFilter(this.fromDate, this.toDate, 'YEAR').subscribe(res => {
      ...
      this.pieChartData = [this.total_threat, this.total_noobject];
  ...
  // public frontregionsBarchart: ChartDataSets[] = [];
  // public frontregionsBarchart_percent: ChartDataSets[] = [];

  // public Front_pieChartData: SingleDataSet = [];
  // public Front_region_Percent_pieChartData: SingleDataSet = [];
  ...
  //   },
  // ];
  // public Front_region_pieChartLabels: Label[] = [
  //   'Upper Front',
  //   'Lower Front',
  ...
  // public BackregionsBarchart: ChartDataSets[] = [];

  // public BackregionsBarchartPercentage: ChartDataSets[] = [];


  // public Back_region_pieChartData: SingleDataSet = [];
  // public Back_region_Percent_pieChartData: SingleDataSet = [];
  // public Back_region_pieChartLabels: Label[] = [
  //   'Upper Back',
  //   'Lower Back',
  ...
  regionLocationsonDone() {
    ...
    //         this.Front_pieChartData.push(dataValue);
    ...
    //         this.Back_region_pieChartData.push(dataValue);
    ...
    //         this.Back_region_Percent_pieChartData.push(percentage);
    //       });
  ...
  totalPersonsScannedReportPDF() {
    ...
    //     doc.text(40, 45, 'Start Date : '
    //       + this.datePipe.transform(this.filtersForm.value.subscribed, 'yyyy-MM-dd ' + this.filtersForm.value.subscribedTime));
    //     doc.text(40, 65, 'End Date   : '
    //       + this.datePipe.transform(this.filtersForm.value.dateTo, 'yyyy-MM-dd ' + this.filtersForm.value.dateToTime));
    //     doc.addPage();
  ...
  regionWiseAlarmsReportPDF() {
    ...
    //     doc.text(40, 20, 'Region Wise Alarms Report');
    //     doc.text(40, 45, 'Start Date : '
    //       + this.datePipe.transform(this.filtersForm.value.subscribed, 'yyyy-MM-dd ' + this.filtersForm.value.subscribedTime));
    //     doc.text(40, 65, 'End Date   : '
    //       + this.datePipe.transform(this.filtersForm.value.dateTo, 'yyyy-MM-dd ' + this.filtersForm.value.dateToTime));
